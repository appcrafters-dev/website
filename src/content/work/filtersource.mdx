...
thumbnail:
  src: '@images/case_studies/case-study-04.jpg'
  alt: 'Banter Template Thumbnail'
coverImage:
  src: '@images/case_studies/case-study-04-cover-image.png'
...
features: ['Meilisearch','Interface for retailers and suppliers', 'ACH integration']
