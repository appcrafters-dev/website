...
thumbnail:
  src: '@images/case_studies/case-study-05.jpg'
  alt: 'Crator Studio template thumbnail'
coverImage:
  src: '@images/case_studies/case-study-05-cover-image.png'
  alt: 'Crator Studio template mockup'
projectURL: 'https://crator.tailwindawesome.com/'
images:
  - src: '@images/case_studies/case-study-05-image-01.png'
    alt: 'Crator Studio case studies archive'
  - src: '@images/case_studies/case-study-05-image-02.png'
    alt: 'Crator Studio team section'
  - src: '@images/case_studies/case-study-05-image-03.png'
    alt: 'Crator Studio features section'
  - src: '@images/case_studies/case-study-05-image-04.png'
    alt: 'Crator Studio contact page'
