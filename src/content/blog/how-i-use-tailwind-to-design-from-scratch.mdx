...
category: 'Tutorials'
image:
  src: '@images/articles/article-02.jpg'
...
<Prism
  lang="bash"
  code={`mkdir my-tailwind-project
...
<Prism
  lang="bash"
  code={`npm install tailwindcss@latest postcss@latest autoprefixer@latest`}
/>
...
<Prism lang="bash" code={`npx tailwindcss init`} />
...
<Prism
  lang="html"
  code={`<header class="bg-gray-800 px-6 py-4 text-white">
