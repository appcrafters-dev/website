...
image:
  src: '@images/articles/article-01.jpg'
  alt: 'Person holding a pencil and writing on a paper in front of a laptop'
...
import formValidationsImage from '@images/articles/form-validations.jpg'
